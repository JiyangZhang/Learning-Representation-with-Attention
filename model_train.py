...
def train(config_path, resume_training=False):
    ...
    d_pool0 = ast.literal_eval(config['hyperparams']['d_pool0'])
    d_pool1 = ast.literal_eval(config['hyperparams']['d_pool1'])
    d_pool2 = ast.literal_eval(config['hyperparams']['d_pool2'])
    d_pool3 = ast.literal_eval(config['hyperparams']['d_pool3'])
    d_plstride0 = ast.literal_eval(config['hyperparams']['d_plstride0'])
    d_plstride1 = ast.literal_eval(config['hyperparams']['d_plstride1'])
    d_plstride2 = ast.literal_eval(config['hyperparams']['d_plstride2'])
    d_plstride3 = ast.literal_eval(config['hyperparams']['d_plstride3'])
    ...
    use_cuda = True
    '''TRAINING DIR'''
    TRAIN_DIR011 = '{}/aol/train_nnrank011/'.format(data_base_path)
    TRAIN_DIR021 = '{}/aol/train_nnrank021/'.format(data_base_path)
    TRAIN_DIR031 = '{}/aol/train_nnrank031/'.format(data_base_path)
    TRAIN_DIR061 = '{}/aol/train_nnrank061/'.format(data_base_path)
    TRAIN_DIR071 = '{}/aol/train_nnrank071/'.format(data_base_path)
    TRAIN_DIR081 = '{}/aol/train_nnrank081/'.format(data_base_path)
    TRAIN_DIR091 = '{}/aol/train_nnrank091/'.format(data_base_path)
    TRAIN_DIR101 = '{}/aol/train_nnrank101/'.format(data_base_path)
    train_files011 = glob.glob("{}/data*.pkl".format(TRAIN_DIR011))
    train_files021 = glob.glob("{}/data*.pkl".format(TRAIN_DIR021))
    train_files031 = glob.glob("{}/data*.pkl".format(TRAIN_DIR031))
    train_files061 = glob.glob("{}/data*.pkl".format(TRAIN_DIR061))
    train_files071 = glob.glob("{}/data*.pkl".format(TRAIN_DIR071))
    train_files081 = glob.glob("{}/data*.pkl".format(TRAIN_DIR081))
    train_files091 = glob.glob("{}/data*.pkl".format(TRAIN_DIR091))
    train_files101 = glob.glob("{}/data*.pkl".format(TRAIN_DIR101))
    train_files = train_files011 + train_files021 + train_files031 + train_files061 \
    + train_files071 + train_files081 + train_files091 + train_files101


    
    '''build model'''
    model = Attention(word_dim, query_length, doc_length, num_heads, 
                bias_mask=None, dropout=0.0, input_dim, hidden_size, batch_size, preemb_path)
